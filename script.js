/*********************** CONFIG ***********************/
const WEBAPP_URL  = 'https://script.google.com/macros/s/AKfycbyYn5NKpSjiYaEnggiuEurXVnJej5De1Bc9gLQ7SKJIF1wNtrZjlw87ni5_R2abFpqGnw/exec'; // URL de Google Apps Script
const SHEET_JSONP = 'https://script.google.com/macros/s/AKfycbx57uJAuvvfeNOsZ-q1TM4XPxMNImB61yFKhkDABmfO6U_2bqveYGLEK2O34VRClnO6HA/exec'; // URL de la hoja RESERVAS
const BLOQUE      = 50;
...
window.addEventListener('DOMContentLoaded', async ()=> {
  // Cargar los cartones desde el archivo JSON
  cartones = await fetch('cartones.json').then(r => r.json());
  cartones.sort((a, b) => a.id - b.id);
  pintarBloque();
  observarScroll();

  // Cargar cartones vendidos desde Google Sheets
